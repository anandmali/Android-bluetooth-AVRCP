...
/**This is source class of AVRCP in google sample,
Most of the time this was represented to make communication Audio device via Bluetooth
Never had seen good example for mobile to mobile communication using AVRCP
In this case the Server ( mobile 1, which established connection ) acts actual mobile device
The accepting device ( mobile 2, which accepting the connection and playing music player in it )
 acts as Audio device wrt AVRCP

This source is not perfect for our example, but it can be generalised for better use
 ...
 */
package anand.android.blemusicaccess;
